namespace WizardsCode.Character
{
	...
	internal static class VersionConstants
	{
		...
		/// </summary>
		public const string GIT_BRANCH = "ManageStates_Death";

		/// <summary>
		/// The current GIT commit hash this package was published on.
		/// </summary>
		public const string GIT_COMMIT = "91c248a39145c51dffc9143b0444354695fed6ed";

		/// <summary>
		/// The UTC human-readable date this package was published at.
		/// </summary>
		public const string PUBLISH_DATE = "Saturday, January 30, 2021";

		/// <summary>
		/// The UTC time this package was published at.
		/// </summary>
		public const string PUBLISH_TIME = "01/30/2021 05:18:37";
	}
}
